...
BTC_who_can_revive  = ["B_medic_F", "O_medic_F", "I_medic_F", "T1_Squad_Medic_Standard_F", "T1_Squad_Medic_BlackCamo_F", "T1_SF_Medic_Standard_F", "T1_Diver_Medic_Standard_F", "T1_Squad_Medic_Standard_Desert_F", "T1_SF_Medic_Standard_Desert_F", "T1_Indep_Squad_Medic_Standard_F", "T1_Indep_SF_Medic_Standard_F", "T1_Indep_Diver_Medic_Standard_F"];
BTC_loop_check      = 0;
...
/*
BTC_deadBodyShown = [];
"BTC_deadBodyShown" addPublicVariableEventHandler {
	[_this] spawn BTC_showDeadBody;
};
*/
...
[] spawn
{
	...
	BTC_defaultgear = [player] call BTC_get_gear;
	//player addEventHandler ["killed", "BTC_gear = [player] call BTC_get_gear;"]; => already called in BTC_player_killed
